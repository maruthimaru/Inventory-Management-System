...
class RepairImageAdapter(private val context: Context, private val list: List<RepairProductImage>) : RecyclerView.Adapter<RepairImageAdapter.MyViewHolder>() {
    private val tempItems: List<RepairProductImage>
